...
export default function GroupFacilitatorEmailInvite({
  navigation,
  route,
}: GroupStackScreenProps<'GroupFacilitatorEmailInvite'>) {
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        <View className='p-5 mt-3 rounded-xl'>
          ...
          <Text className='text-storm '>
            ...
            comma (,) to seperate email addresses to invite multiple
            co-facilitator.
          </Text>
        </View>
